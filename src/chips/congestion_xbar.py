...
for i in range(1, n_samples+1):
    ...
    if i in train_idx:
        train_data.append((node_features, edge_features, vn_features, super_vn_features, hypergraph, congestion))
    elif i in valid_idx:
        valid_data.append((node_features, edge_features, vn_features, super_vn_features, hypergraph, congestion))
    elif i in test_idx:
        test_data.append((node_features, edge_features, vn_features, super_vn_features, hypergraph, congestion))
...
torch.save(model, 'congestion_xbar.pt')